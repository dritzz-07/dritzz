      ...
      <div className="relative z-10 w-full h-full flex flex-col min-h-screen">
        ...
        <main className="flex-grow pt-32 pb-20 px-4 md:px-8 max-w-4xl mx-auto w-full">
          ...
          <div className="prose prose-invert max-w-none text-neutral-300 space-y-6">
            ...
            <h2 className="text-xl font-bold text-white mt-8 mb-4">Customer Data Collection</h2>
            ...
            <h2 className="text-xl font-bold text-white mt-8 mb-4">Phone OTP Authentication</h2>
            <p>For secure access to your account and to verify service addresses, we utilize Phone OTP authentication.</p>
            
            <h2 className="text-xl font-bold text-white mt-8 mb-4">Vehicle and Booking Details</h2>
            ...
            <h2 className="text-xl font-bold text-white mt-8 mb-4">Payment Processing Information</h2>
            ...
            <h2 className="text-xl font-bold text-white mt-8 mb-4">WhatsApp/SMS Notifications</h2>
            ...
            <h2 className="text-xl font-bold text-white mt-8 mb-4">User Data Protection</h2>
            <p>Your data is insulated using standard security practices to prevent unauthorized access.</p>
            
            <h2 className="text-xl font-bold text-white mt-8 mb-4">Third-Party Services Usage</h2>
