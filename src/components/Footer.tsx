      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <ul className="space-y-4 text-sm w-full">
            <li><Link to="/about-us" className="hover:text-white transition-colors block py-1">About Us</Link></li>
            <li><Link to="/contact-us" className="hover:text-white transition-colors block py-1">Contact Us</Link></li>
            <li><Link to="/privacy-policy" className="hover:text-white transition-colors block py-1">Privacy Policy</Link></li>
            <li><Link to="/terms-and-conditions" className="hover:text-white transition-colors block py-1">Terms & Conditions</Link></li>
            <li><Link to="/refund-policy" className="hover:text-white transition-colors block py-1">Refund Policy</Link></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col items-start text-left w-full">
          ...
          <ul className="space-y-4 text-sm w-full">
            <li className="w-full">
              <a href="https://wa.me/917075504625" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-start gap-3 bg-white/5 hover:bg-green-500/10 border border-white/5 hover:border-green-500/30 px-4 py-2.5 rounded-xl transition-all group w-full sm:w-auto">
            ...
            <li>
              <a href="tel:+917075504625" className="flex items-center justify-start gap-3 hover:text-white transition-colors py-1">
                <Phone className="w-4 h-4 shrink-0" />
                <span>+91 7075504625</span>
              </a>
            </li>
            <li>
              <a href="mailto:dritzz.info@gmail.com" className="flex items-center justify-start gap-3 hover:text-white transition-colors py-1">
                <Mail className="w-4 h-4 shrink-0" />
                <span className="break-all">dritzz.info@gmail.com</span>
              </a>
            </li>
            <li>
              <a href="https://dritzz.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-3 hover:text-white transition-colors py-1">
