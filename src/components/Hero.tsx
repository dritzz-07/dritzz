...
export default function Hero() {
  ...
  const handleCarClick = () => {
    ...
    if (playPromise !== undefined) {
      playPromise.catch(e => {
        console.warn("Local audio not found, please upload car-start.mp3 to the public folder. Error:", e);
        setIsStarting(false);
      });
    }
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12 -mb-[35px]">
        ...
        >
          <div className="flex items-center gap-4 bg-white/5 border border-white/10 px-5 py-3 rounded-2xl shadow-[0_0_20px_rgba(255,255,255,0.05)] ">
            ...
            >
              <Droplets className="w-6 h-6 text-white" style={{ backgroundColor: '#66a7e9' }} />
            </motion.div>
        ...
        >
          <a href="#booking" className="btn-primary decoration-none">Book Now</a>
          <a href="#packages" className="btn-secondary decoration-none hover:!text-white">View Pricing</a>
        </motion.div>
        ...
        >
          ...
          <img 
            ...
            style={{ borderStyle: 'none', borderRadius: '10px', backgroundColor: '#000000' }}
          />
        </motion.div>
      </div>
