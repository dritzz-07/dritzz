...
import { Droplets, Sparkles, Wind, SprayCan, PaintBucket, CircleDashed } from 'lucide-react';

const SERVICES = [
  {
    id: 'exterior-wash',
    title: 'Exterior Wash',
    description: 'High-pressure foam wash to remove dirt, grit, and grime without scratching your paint.',
    icon: Droplets,
  ...
  },
  {
    ...
    description: 'Deep vacuuming of seats, carpets, and boot to remove dust and debris.',
    icon: Wind,
  ...
  },
  {
    ...
    description: 'Restoration and UV protection for plastics, vinyl, and dashboard components.',
    icon: SprayCan,
  ...
  },
  {
    id: 'stain-removal',
    title: 'Dry Cleaning',
    description: 'Intensive deep cleaning and stain removal for fabric and leather upholstery.',
    icon: Sparkles,
  ...
  },
  {
    id: 'waxing',
    title: 'Wax & Polish',
    description: 'Premium liquid wax application for long-lasting shine and environmental protection.',
    icon: PaintBucket,
  ...
  },
  {
    ...
    description: 'Deep rim cleaning and tire dressing for a gloss black finish.',
    icon: CircleDashed,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-neutral-300">Our Services</span>
          </motion.div>
          ...
          >
            Dritzz <span className="font-bold relative">Services<span className="absolute -bottom-2 left-0 w-1/2 h-1 bg-blue-500"></span></span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            return (
              ...
              >
                ...
                <div className="relative p-8 rounded-2xl bg-black/40 border border-white/5 backdrop-blur-sm h-full flex flex-col justify-start">
                  ...
                  <p className="text-neutral-400 text-sm leading-relaxed font-light">{service.description}</p>
                </div>
              </motion.div>
            );
          })}
